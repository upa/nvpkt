...
set output "graph/graph-iops_".direct."_walk-".walk."_msg-vs-batch.pdf"
...
set yrange [0:]
plot	"dat/".direct."_iops_walk-".walk."_msg_vs_batch.dat"	\
	using 0:2:xtic(1) with lp title "batch=1",	\
	"dat/".direct."_iops_walk-".walk."_msg_vs_batch.dat"	\
